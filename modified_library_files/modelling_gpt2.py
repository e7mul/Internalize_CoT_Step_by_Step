...
def eager_attention_forward(module, query, key, value, attention_mask, head_mask=None, **kwargs):
    ...
    attn_weights = attn_weights * module.get_temperature_logits().view(1, module.num_heads, 1, 1)
...
class GPT2Attention(nn.Module):
    def __init__(self, config, is_cross_attention=False, layer_idx=None):
        ...
        self.temperature_init_value = math.log(config.temperature_init_value)
        ...
        if self.temperature_learnable:
            ...
            self.register_buffer(
                'temperature_logits',
                torch.full((self.num_heads,), self.temperature_init_value, dtype=torch.float32)
            )
    ...
    def get_temperature_logits(self):
        return torch.exp(self.temperature_logits)
...
class GPT2PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        # Handle temperature_logits initialization
        if hasattr(module, 'temperature_logits') and hasattr(module, 'temperature_init_value'):
            # Initialize temperature_logits with the correct value from config
            module.temperature_logits.data.fill_(module.temperature_init_value)
